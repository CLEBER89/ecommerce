...
<html lang="pt-br">
  <head>
    ...
    <title>NSA Store</title>
    <link href="views/res/site/img/icon.png" rel="shortcut icon" type="image/x-icon" />
    ...
    <!--[if lt IE 9]>
      <script src="views/res/site/viewsviewshttps://oss.maxcdn.com/html5shiv/3.7.2/html5shiv.min.js"></script>
      <script src="views/res/site/viewsviewshttps://oss.maxcdn.com/respond/1.4.2/respond.min.js"></script>
    <![endif]-->
  </head>
  <body>
